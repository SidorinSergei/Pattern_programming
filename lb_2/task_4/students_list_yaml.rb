...
class StudentsListYAML < StudentsListBase
  ...
  def initialize(path='C:/Users/79892/Documents/GitHub/Pattern_programming/lb_2/task_4/test_read_yaml.yaml')
    super
  end

  def write_to_file(path='C:/Users/79892/Documents/GitHub/Pattern_programming/lb_2/task_4/test_write_yaml.yaml')
    begin
